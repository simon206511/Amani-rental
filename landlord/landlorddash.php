...
$tenantName = $result ? $result['name'] : 'User'; // Use 'name' from the SQL dump
    ...
    <nav class="sidebar">
        <header>
            <div class="image-text">
                <span class="image">
                    <img src="resources/img/amani-logo.png" alt="">
                </span>
        ...
        <div class="menu-bar">
            <div class="menu">
                <ul class="menu-links">
                    <li class="nav-link">
                        <a href="dash.php" id="dashboard-link">
                    ...
                    <li class="nav-link">
                        <a href="addproperty.php">
                            ...
                            <span class="text nav-text">Add Apartments</span>
                        </a>
                    </li>

                    <li class="nav-link">
                        <a href="housetype.php">
                            <i class='bx bx-building-house icon'></i>
                            <span class="text nav-text">Apartments Type</span>
                        </a>
                    </li>
